...
//
            Slider(value: $currentTime,
                   ...
                   minimumValueLabel: Text("\(Utility.formatSecondsToHMS(currentTime))").foregroundColor(.white),
                   maximumValueLabel: Text("\(Utility.formatSecondsToHMS(currentDuration))").foregroundColor(.white)) {
